...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem {Improved fault tolerance of synthetic testing systems of 4 classes of internal GitHub Actions runners by developing a failure recovery script using Python and GitHub APIs to detect and recover workflow scheduling failures.}
