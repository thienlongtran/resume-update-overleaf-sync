...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Established visibility into cost areas and optimization potentials for \$14,400,000 worth of enterprise CI/CD jobs annually by integrating GitHub Actions Observability API with DataDog cost metrics using Python.}
    \resumeItemListEnd
     \resumeSubheading
