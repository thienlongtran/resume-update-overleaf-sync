...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      {Incoming Software Engineer Intern}{Austin, TX}
      \resumeItemListStart
      \resumeItem {Joining PayPal for an exciting, enriching, and character-building experience this upcoming summer!}
    \resumeItemListEnd
    \resumeSubheading
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Stock Simple Moving Average (SMA) Pipeline} $|$ \emph{AWS, Python}}{}
          \resumeItemListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed a program that automatically gathers 4 different attributes about users’ in-game Warframe inventory items, saving users about 52 seconds of work per item page compared to manual calculation.}
