...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem {Improved fault tolerance of synthetic testing systems of 4 classes of internal GitHub Actions runners by developing a failure recovery script using Python and GitHub APIs that detects and recovers workflow scheduling failures.}
      \resumeItem {Enabled 24/7 reliability of GitHub Actions synthetic tests by deploying the failure recovery script to AWS Lambda using Terraform which triggers every 5 minutes, recovers about 25 failures a day, and costs \$0.57 a month.}
    \resumeItemListEnd
    \resumeSubheading
