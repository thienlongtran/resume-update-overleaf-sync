...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Generated 24.66\% portfolio return per month with a 1.42 Sharpe Ratio by developing an NBA Sports Betting Strategy on Totals Market's Over/Under (OU) Lines using a configuration of 2.5\% of bankroll per trade.}
