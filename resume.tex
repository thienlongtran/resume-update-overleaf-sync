...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Improved fault tolerance of Datadog metrics collection of 4 classes of internal GitHub Actions runners by using Python, GitHub APIs, and AWS Lambda to automate checking and recovery of synthetic testing workflow failures.}
    \resumeItemListEnd
    \resumeSubheading
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Generated a list of inventory items using OpenCV to isolate item names from the inventory-screen image by thresholding the text colors, and using PyTesseract to read and save the remaining text.}
