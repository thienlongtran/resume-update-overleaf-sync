...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Generated 24.66\% return on investment (ROI) per month with a 1.42 Sharpe Ratio by developing an NBA Sports Betting Strategy on Totals Market's Over/Under (OU) Lines with a configuration of 2.5\% of bankroll per trade.}
