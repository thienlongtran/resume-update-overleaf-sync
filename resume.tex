...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Enabled 24/7 reliability of GitHub Actions synthetic tests by deploying the failure recovery script to AWS Lambda using Terraform which triggers every 5 minutes, recovers up to 25 failures a day, and costs \$0.57 a month.}
      \resumeItem {Provided better GitHub infrastructure observability by designing and developing a new GitHub App that receives workflow webhooks and delivers 3 key metrics about current builds running across Venmo's 780+ repositories.}
    \resumeItemListEnd
    \resumeSubheading
