...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Saved the company \$1,142,000 annually by replacing an unoptimized, continuously running metrics collection process with an optimized, aggregation interval algorithm using Python and AWS Elastic Kubernetes Service.}
    \resumeItemListEnd
     \resumeSubheading
