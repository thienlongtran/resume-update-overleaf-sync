...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Improved fault tolerance of Datadog synthetic testing metrics collection of 4 classes of internal GitHub Actions runners by developing automated scheduling-failure recovery using AWS Lambda, Python, and GitHub APIs.}
    \resumeItemListEnd
    \resumeSubheading
