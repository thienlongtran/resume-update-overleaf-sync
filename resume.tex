...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Enabled 24/7 reliance of GitHub Actions synthetic testing by deploying the failure recovery script to AWS Lambda using Terraform which constantly runs every 5 minutes, recovers about 25 failures a day, and costs \$0.57 a month.}
      \resumeItem {Created a playbook for deploying critical CI/CD workflows without GitHub Actions in the event of total failure of GitHub Enterprise by researching and evaluating three break-glass contingency options.}
    \resumeItemListEnd
    \resumeSubheading
