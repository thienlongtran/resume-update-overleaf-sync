...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      %    {\textbf{NBA Sportsbetting Investment w/ Machine Learning} $|$ \emph{Python, XGBoost}}{}
       %   \resumeItemListStart
        %    \resumeItem{Developed an NBA Sports Betting Strategy on Over/Under (OU) Lines with an average monthly 42.4\% return on investment (ROI) when using 3.0\% of monthly bankroll per bet.}
