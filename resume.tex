...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed an NBA Sports Betting Strategy on Over/Under (OU) Lines with an average monthly 35.66\% return on portfolio when using 2.5\% of monthly bankroll per bet.}
            \resumeItem{Trained an XGBoost model to predict results of OU Lines with 56.37\% accuracy, providing a 7.67\% ROI per bet.}
            \resumeItem{Automated betting by utilizing CloudBet API to schedule bets right before the start of a game.}
          \resumeItemListEnd
      \resumeProjectHeading
