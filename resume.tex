...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Increased fault tolerance of Datadog metrics collection of 4 classes of internal GitHub Actions runners by developing scheduling failure recovery using Python and GitHub APIs which affected 4 synthetic testing workflows.}
    \resumeItemListEnd
    \resumeSubheading
