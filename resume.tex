...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      {Venmo}{August 2022 - Present}
      {Software Engineer}{Austin, TX}
      \resumeItemListStart
      %\resumeItem {Provided  .} TALK ABOUT OBSERVABILITY SERVICE HERE
      \resumeItem {Saved company \$1,142,000 annually in compute costs by replacing an unoptimized, continuously running metrics collection process with an interval aggregation algorithm using Python and AWS Elastic Kubernetes Service.}
      \resumeItem {Enabled visibility into cost areas and optimization potential on enterprise workflows for \$14,400,000 worth of CI/CD jobs annually by integrating GitHub Actions Observability API with DataDog metrics using Python.}
    \resumeItemListEnd
     \resumeSubheading
      ...
      \resumeItem {Provided better GitHub Actions observability by designing and developing a scalable, high performance microservice using Python, Flask, Docker, AWS Elastic Kubernetes Service, and AWS DynamoDB which delivers 11 key real time metrics about workflow jobs currently active across Venmo's 1200+ repositories.}
    \resumeItemListEnd
    \resumeSubheading
