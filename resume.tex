...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Saved company \$1,242,000 annually in compute costs by replacing an unoptimized, continuously running metrics collection process with an interval aggregation algorithm using Python and AWS Elastic Kubernetes Service.}
