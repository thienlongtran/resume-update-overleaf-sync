...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Educated dozens of Platform Infrastructure Engineers and enabled them to support GitHub Actions during on-call rotations by creating an introductory course to Venmo's CI/CD infrastructure and observability.}
    \resumeItemListEnd
%     \resumeSubheading
