...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}\hspace*{1cm}{Python, Go, Java, HTML, CSS, JavaScript, SQL} \\
...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Assumed responsibilities of Venmo's Site Reliability Engineering team including networking, security, cluster maintenance, observability, operation efficiency and stability, and incident response management services.}
      \resumeItem {Prevented an internal tools incident by spearheading an effort between 6 teams to replace a critical, quickly expiring, sensitive SSL certificate in a manner consistent with new company and PCI Data Security Standards.}
      \resumeItem {Became SRE's established engineer for helping the PCI DSS auditing and network assessment teams.}
...
%          {\textbf{LightningDates -- IRL Tinder Startup} $|$ \emph{Python, Twilio}}{}
%          \resumeItemListStart
%            \resumeItem{Built and launched a speed dating startup in 2 weeks, leading to a total of 8 events hosted and \$620 generated within the Houston community in the first 3 weeks post-launch.}
 %           \resumeItem{Created an SMS-based dating event hoster Minimim Viable Product (MVP) using Flask and Twilio APIs.}
 %           \resumeItem{Built a landing page from scratch in a weekend using HTML, TailwindCSS, GitHub Pages, and Midjourney.}
%          \resumeItemListEnd
      \resumeProjectHeading
