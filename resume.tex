...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem {Improved fault tolerance of synthetic testing systems of 4 classes of internal GitHub Actions runners by using Python and GitHub APIs to discover and recover workflow scheduling failures.}
      \resumeItem {Enabled 24/7 reliance of GitHub Actions synthetic testing by deploying the failure recovery script to AWS Lambda using Terraform which triggers every 5 minutes, recovers about 25 failures a day, and costs \$0.57 a month.}
