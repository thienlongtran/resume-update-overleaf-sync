...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Saved company \$1,242,700 annually in compute and data transfer costs by identifying an unoptimized, continuously running metrics collection process and replacing it with an interval aggregation algorithm using Python.}
