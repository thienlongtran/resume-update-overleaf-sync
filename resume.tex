...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Improved fault tolerance of Datadog metrics collection of 4 classes of internal GitHub Actions runners by using Python, GitHub APIs, and AWS Lambda to automate testing and recovery of synthetic testing workflow failures.}
    \resumeItemListEnd
    \resumeSubheading
