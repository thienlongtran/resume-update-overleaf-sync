...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Improved fault tolerance of Datadog synthetic testing metrics collection of 4 classes of internal GitHub Actions runners by automating checking and recovery of workflow failures using Python, GitHub APIs, and AWS Lambda.}
    \resumeItemListEnd
    \resumeSubheading
    ...
    \resumeItemListStart
      ...
      \resumeItem {Decreased the cost of conducting network connectivity testing on AWS EC2 instances by 92.38\% by developing a selection of 5 AWS Systems Manager (SSM) testing automations using Terraform and GitLab CI/CD.}
