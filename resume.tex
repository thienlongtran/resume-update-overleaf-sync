...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem {Joined Venmo, a PayPal service, for an exciting and enriching internship for the Summer of 2022!}
      \resumeItem {Increased fault tolerance of Datadog metrics collection of 4 classes of internal GitHub Actions runners by developing scheduling failure recovery using Python and GitHub APIs which strengthened 4 synthetic testing workflows.}
    \resumeItemListEnd
    \resumeSubheading
