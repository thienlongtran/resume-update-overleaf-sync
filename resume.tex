...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      \resumeItem {Saved the company \$1,242,000 annually by replacing an unoptimized, continuously running metrics collection process with an optimized, iterative-aggregation algorithm using Python and AWS Elastic Kubernetes Service.}
    \resumeItemListEnd
     \resumeSubheading
