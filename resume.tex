...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Generated 35.66\% return on portfolio per month by developing an NBA Sports Betting Strategy on Over/Under (OU) Lines when using a configuration of 2.5\% of fixed monthly bankroll per bet (14.26x bet size profit/month).}
